...
export const el = {
  ...
  trashToggleIcon: document.getElementById('trash-toggle-icon'),
  ...
  previewNavButtons: document.getElementById('preview-nav-buttons'),
  previewNavCompact: document.getElementById('preview-nav-compact'),
  previewNavPrev: document.getElementById('preview-nav-prev'),
  previewNavNext: document.getElementById('preview-nav-next'),
