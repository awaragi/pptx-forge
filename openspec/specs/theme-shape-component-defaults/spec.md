...
Defines per-component visual defaults in `theme.shape`, enabling workspace-level control over component geometry and colors without editing individual slide files.
