...
A `.github/workflows/release.yml` workflow SHALL trigger on pushes to tags matching the pattern `[0-9]*.*`, create a zip archive of the repository using `git archive`, and publish a GitHub release with the archive and auto-generated notes.
